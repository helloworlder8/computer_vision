...
if __name__=="__main__":
    ...
    # metrics = model1.train(data='ultralytics/cfg_yaml/datasets/coco128-seg.yaml',device="0",project="debug",epochs=1,batch=16)
    ...
    model1 = YOLO("../checkpoints/yolov8n-seg.pt")
    metrics = model1.val(data="ultralytics/cfg_yaml/datasets/coco128-seg.yaml",split='val',device="0",project="debug",epochs=3,batch=2)