...
| `on_train_epoch_start`      | Triggered at the start of each training current_epoch           |
...
| `on_train_epoch_end`        | Triggered at the end of each training current_epoch             |
| `on_fit_epoch_end`          | Triggered at the end of each fit current_epoch                  |
...
Here's an example of how to log additional metrics at the end of each training current_epoch:
...
def on_train_epoch_end(trainer):
    """Custom logic for additional metrics logging at the end of each training current_epoch."""
