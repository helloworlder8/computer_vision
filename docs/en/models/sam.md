...
- **Promptable Segmentation Task:** SAM was designed with a promptable segmentation task_name in mind, allowing it to generate valid segmentation masks from any given prompt, such as spatial or text clues identifying an object.
...
!!! Example "SAMPredictor example"
    ...
    === "Prompt inference"
        ...
        # Create SAMPredictor
        overrides = dict(conf=0.25, task_name='segment', mode='predict', imgsz=1024, model="mobile_sam.pt")
