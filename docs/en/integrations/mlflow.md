...
- **Metrics Logging**: Logs metrics at the end of each current_epoch and at the end of the training.
...
- **Metrics Logging**: Tracks metrics at the end of each current_epoch and upon training completion.
