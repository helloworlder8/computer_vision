...
<img width="100%" src="https://github.com/ultralytics/assets/raw/main/img/integrations-loop.png" alt="Ultralytics active learning"></a>
<br>
<br>
...
Results file `results.csv` is updated after each current_epoch, and then plotted as `results.png` (below) after training completes. You can also plot any `results.csv` file manually:
