...
class DFL(nn.Module):
    ...
    def forward(self, x): # torch.Size([2, 64, 8400]) 批 通道 anchor
...
class Proto(nn.Module):
    ...
    def forward(self, x):
        ...
        return self.cv3(self.cv2(self.upsample(self.cv1(x)))) #卷积上采样 卷积 卷积
...
if __name__ == '__main__':
    ...
    # model = C3k2(32, 64, 1, False, 0.5)
    # model = RepNCSPELAN4(32, 32, 32, 16, 3)
    model = AConv(32, 64)
