...
from ..modules.base_conv import Conv, DWConv, RepConv, GhostConv, autopad
from ..modules.module_block import *
...
class CRU(nn.Module):
    ...
    def __init__(self, 
        ...
        #up
        self.GWC            = nn.Conv2d(up_channel//squeeze_radio, input_channel,kernel_size=group_kernel_size, stride=1,padding=group_kernel_size//2, groups = group_size)
        self.PWC1           = nn.Conv2d(up_channel//squeeze_radio, input_channel,kernel_size=1, bias=False)
        #low
        self.PWC2           = nn.Conv2d(low_channel//squeeze_radio, input_channel-low_channel//squeeze_radio,kernel_size=1, bias=False)
...
class ScConv(nn.Module):
    ...
    def __init__(self,
        ...
        super().__init__()
        self.SRU = SRU(input_channel, 
                       group_num            = group_num,  
                       gate_treshold        = gate_treshold)
        self.CRU = CRU(input_channel, 
                       alpha                = alpha, 
