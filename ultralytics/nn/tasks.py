...
class RTDETRDetectionModel(DetectionModel):
    ...
    def loss(self, batch, preds=None):
        ...
        preds = self.predict(img, targets=targets) if preds is None else preds
...
def load_download_model_attribute_assignment(model_pt, device=None, inplace=True, fuse=False):
