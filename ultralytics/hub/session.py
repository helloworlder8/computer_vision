...
class HUBTrainingSession:
    ...
    def __init__(self, identifier):
        ...
        self.metrics_queue = {}  # holds metrics for each current_epoch until upload
        self.metrics_upload_failed_queue = {}  # holds metrics for each current_epoch if upload failed
    ...
    def upload_model(
        ...
        Args:
            current_epoch (int): The current training current_epoch.
