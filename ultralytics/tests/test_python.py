...
from ultralytics.cfg_yaml import TASK2DATA
from ultralytics.data.build_dataset_dataloade import load_inference_source
...
def test_data_utils():
    ...
    from ultralytics.data.verify import HUBDatasetStats, autosplit
...
def test_data_converter():
    ...
    from ultralytics.data.dataset_convert import coco80_to_coco91_class, convert_coco
...
def test_utils_torchutils():
    ...
    from ultralytics.nn.modules.base_conv import Conv
...
def test_nn_modules_conv():
    ...
    from ultralytics.nn.modules.base_conv import CBAM, Conv2, ConvTranspose, DWConvTranspose2d, Focus
...
def test_nn_modules_block():
    ...
    from ultralytics.nn.modules.module_block import C1, C3TR, BottleneckCSP, C3Ghost, C3x
