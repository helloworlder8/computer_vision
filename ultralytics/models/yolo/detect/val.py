...
class DetectionValidator(BaseValidator):
    ...
    def build_dataset(self, img_path, mode="val", batch=None):
        ...
        """
        return build_yolo_dataset(self.args, img_path, self.data_dict, batch, mode=mode, stride=self.stride)

    def get_dataloader(self, dataset_str, batch_size):
        """Construct and return dataloader."""
        dataset = self.build_dataset(dataset_str, batch=batch_size, mode="val")
