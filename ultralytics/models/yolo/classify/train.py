...
class ClassificationTrainer(BaseTrainer):
    ...
    def get_model(self, cfg=None, weights=None, verbose=True):
        ...
        model = ClassificationModel(cfg,ch=ch, nc=self.data_dict["nc"], verbose=verbose and RANK == -1)
        if weights:
            model.load(weights)
    ...
    def _get_loss_names_validator(self):
        ...
        return yolo.classify.ClassificationValidator(args=copy(self.args),dataloader = self.test_loader, save_dir = self.save_dir, _callbacks=self.callbacks)
    ...
    def plot_training_samples(self, batch, ni):
        ...
        plot_images(
            images=batch["img"],
            img_idx=torch.arange(len(batch["img"])),
