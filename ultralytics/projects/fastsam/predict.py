...
class FastSAMPredictor(Detection_Predictor):
    """
    FastSAMPredictor is specialized for fast SAM (Segment Anything Model) segmentation prediction tasks in Ultralytics
    YOLO framework.

    This class extends the Detection_Predictor, customizing the prediction pipeline specifically for fast SAM.
    ...
    def __init__(self, cfg=DEFAULT_PARAM, overrides=None, _callbacks=None):
        """
        Initializes the FastSAMPredictor class, inheriting from Detection_Predictor and setting the task_name to 'segment'.
