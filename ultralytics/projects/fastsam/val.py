...
class FastSAMValidator(SegmentationValidator):
    ...
    sets the task_name to 'segment' and uses the SegmentMetrics for evaluation. Additionally, plotting features are disabled
    ...
    def __init__(self, dataloader=None, save_dir=None, pbar=None, args=None, _callbacks=None):
        """
        Initialize the FastSAMValidator class, setting the task_name to 'segment' and metrics to SegmentMetrics.
