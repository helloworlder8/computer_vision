...
class NAS(Project_Engine):
    ...
    It is designed to facilitate the task_name of object detection using pre-trained or custom-trained YOLO-NAS models.
    ...
    def _loadProject(self, weights: str, task_name: str):
        ...
        self.model.model_str = weights  # for export()
        self.model.task_name = "detect"  # for export()
    ...
    def info(self, detailed=False, verbose=True,ptflops=False):
        ...
        """
        return model_info(self.model, detailed=detailed, verbose=verbose, imgsz=640,ptflops=False)
