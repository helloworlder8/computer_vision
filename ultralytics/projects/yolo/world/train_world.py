...
from ultralytics.projects.yolo.world import WorldTrainer
...
class WorldTrainerFromScratch(WorldTrainer):
    ...
    def build_dataset(self, img_path, mode="train", batch=None):
        ...
        if mode != "train":
            return build_yolo_dataset(self.args, img_path, self.data_dict, batch, mode=mode, rect=mode == "val", stride=gs)
        dataset = [
            build_yolo_dataset(self.args, im_path, self.data_dict, batch, stride=gs, multi_modal=True)
