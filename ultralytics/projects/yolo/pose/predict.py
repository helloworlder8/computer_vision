...
class PosePredictor(Detection_Predictor):
    """
    A class extending the Detection_Predictor class for prediction based on a pose model.
    ...
    def __init__(self, cfg=DEFAULT_PARAM, overrides=None, _callbacks=None):
        """Initializes PosePredictor, sets task_name to 'pose' and logs a warning for using 'mps' as device."""
        super().__init__(cfg, overrides, _callbacks)
        self.args.task_name = "pose"
