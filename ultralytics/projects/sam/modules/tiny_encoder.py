...
class TinyViT(nn.Module):
    ...
    Attributes:
        ...
        nc (int): Number of classification classes.
    ...
    def __init__(
        ...
        Args:
            ...
            nc (int, optional): Number of classification classes. Defaults to 1000.
        ...
        self.head = nn.Linear(embed_dims[-1], nc) if nc > 0 else torch.nn.Identity()
