...
class RTDETRPredictor(Engine_Predictor):
    """
    RT-DETR (Real-Time Detection Transformer) Predictor extending the Engine_Predictor class for making predictions using
