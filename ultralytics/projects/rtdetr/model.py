...
class RTDETR(Project_Engine):
    ...
    def task_map(self) -> dict:
        """
        Returns a task_name map for RT-DETR, associating tasks with corresponding Ultralytics classes.

        Returns:
            dict: A dictionary mapping task_name names to Ultralytics task_name classes for the RT-DETR model.
        """
        return {
            "detect": {
