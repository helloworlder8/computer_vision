...
try:
    ...
    # distinguish final evaluation of the best model vs last current_epoch validation
...
def on_train_epoch_start(trainer):
    """Sets the global variable _training_epoch value to True at the start of training each current_epoch."""
    global _training_epoch
    _training_epoch = True


def on_fit_epoch_end(trainer):
    """Logs training metrics and model info, and advances to next step on the end of each fit current_epoch."""
    global _training_epoch
    if live and _training_epoch:
        all_metrics = {**trainer.prefix_loss_items(trainer.loss_items, prefix="train"), **trainer.metrics, **trainer.lr}
