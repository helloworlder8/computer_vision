...
GITHUB_ASSETS_STEMS = [Path(k).stem for k in GITHUB_ASSETS_NAMES] #list
...
def attempt_download_asset(file, repo="ultralytics/assets", release="v8.1.0", **kwargs): #'yolov8n.pt'

    from ultralytics.utils import SETTINGS  # scoped for circular import

    file = str(file) #'yolov8n.pt'
