...
from ultralytics.utils import DEFAULT_PARAM, LOGGER, callbacks, colorstr, remove_colorstr, yaml_print, yaml_save
...
class Tuner:
    ...
    def __init__(self, args=DEFAULT_PARAM, _callbacks=None):
        """
        ...
        self.tune_dir = creat_save_dir(self.args, name="tune")
    ...
    def __call__(self, model=None, iterations=10, cleanup=True):
        ...
        for i in range(iterations):
            ...
            save_dir = creat_save_dir(creat_args(train_args))
