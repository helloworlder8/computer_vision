...
class Format:
    ...
    Attributes:
        ...
        img_idx (bool): Whether to keep batch indexes.
    ...
    def __init__(
        ...
        Args:
            ...
            img_idx (bool): If True, keeps batch indexes.
        ...
        self.img_idx = img_idx  # keep the batch indexes
        self.bgr = bgr
    ...
    def __call__(self, labels):
        ...
        Returns:
            (Dict): A dictionary with formatted data, including:
                ...
                - 'img_idx': Batch index tensor (if img_idx is True).
...
def v8_transforms(dataset, imgsz, hyp, stretch=False):
    ...
    if dataset.use_keypoints:
        kpt_shape = dataset.data_dict.get("kpt_shape", None)
