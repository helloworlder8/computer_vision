...
from ultralytics.cfg_yaml import TASK2DATA, get_args
...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        self.pretty_name = Path(self.model.yaml.get("model_yaml", self.file)).stem.replace("yolo", "YOLO")
    ...
    def export_openvino(self, prefix=colorstr("OpenVINO:")):
        ...
        def serialize(ov_model, file):
            ...
            ov_model.set_rt_info(self.args.NMS_Threshold, ["model_info", "iou_threshold"])
        ...
        if self.args.int8:
            ...
            def transform_fn(data_item) -> np.ndarray:
                ...
                img = data_item.numpy().astype(np.float32) / 255.0  # uint8 to fp16/32 and 0 - 255 to 0.0 - 1.0
    ...
    def export_paddle(self, prefix=colorstr("PaddlePaddle:")):
        ...
        pytorch2paddle(module=self.model, save_dir=f, jit_type="trace", input_examples=[self.img])  # export
    ...
    def export_coreml(self, prefix=colorstr("CoreML:")):
        ...
        if self.model.task == "classify":
            ...
            model = IOSDetectModel(self.model, self.img) if self.args.nms else self.model
        else:
            if self.args.nms:
...
class IOSDetectModel(torch.nn.Module):
    ...
    def __init__(self, model, img):
        ...
        super().__init__()
        _, _, h, w = img.shape  # batch, channel, height, width
        self.model = model
