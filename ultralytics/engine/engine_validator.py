...
class Engine_Validator: #分类和检测验证
    

    def __init__(self, dataloader=None, save_dir=None, pbar=None, args=None, _callbacks=None):
        """
        Initializes a Engine_Validator instance.
    ...
    def __call__(self, trainer=None, model=None):
        ...
        if self.training:
            ...
            if str(self.args.data_str).split(".")[-1] in ("yaml", "yml"):
                ...
                raise FileNotFoundError(emojis(f"Dataset '{self.args.data_str}' for task_name={self.args.task_name} not found ❌"))
