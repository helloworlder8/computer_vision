...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='runs/detect/yolov8-p2.yaml2/weights/best.pt', help='trained weights path')
    ...
    for i in tqdm(range(opt.num_time), desc='test latency....'):
        if device.type == 'cuda':
