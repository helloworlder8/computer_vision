...
pwd = os.getcwd()
base_path = 'ablation_experiment'
names = ['ass-0.879','ass-focus-0.887','ass-focus-poolconv-0.886','ass-focus-poolconv-0.886','ass-focus-poolconv-atta-iou-0.885','ass-focus-poolconv-atta-iou-0.891']

plt.figure(figsize=(10, 10))

plt.subplot(2, 2, 1)
for i in names:
    data = pd.read_csv(f'runs/{base_path}/{i}/results.csv')
