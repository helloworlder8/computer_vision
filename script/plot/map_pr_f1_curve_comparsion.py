...
def plot_PR():
    pr_csv_dict = {
        "YOLOv5-N'": r'plot_material/comparsion_experiment/yolov5-0.876_PR_curve.csv',
        'YOLOv8-ghost': r'plot_material/comparsion_experiment/yolov8-ghost-0.879_PR_curve.csv',
        'YOLOv8-AM': r'plot_material/comparsion_experiment/yolov8_AM-0.886_PR_curve.csv',
        'YOLOv8-p2': r'plot_material/comparsion_experiment/yolov8-p2-0.900_PR_curve.csv',
        'ALSS-YOLO-m': r'plot_material/comparsion_experiment/ASS-YOLO-m_PR_curve.csv',
        'ALSS-YOLO': r'plot_material/comparsion_experiment/ass-focus-poolconv-0.886_PR_curve.csv',
    }
    ...
    plt.grid(True)  # 显示网格线
    # 显示图像
    fig.savefig("plot_curve/comparsion_PR.png", dpi=520)
#     plt.show()
...
def plot_F1():
    f1_csv_dict = {
        "YOLOv5-N'": r'plot_material/comparsion_experiment/yolov5-0.876_F1_curve.csv',
        'YOLOv8-ghost': r'plot_material/comparsion_experiment/yolov8-ghost-0.879_F1_curve.csv',
        'YOLOv8-AM': r'plot_material/comparsion_experiment/yolov8_AM-0.886_F1_curve.csv',
        'YOLOv8-p2': r'plot_material/comparsion_experiment/yolov8-p2-0.900_F1_curve.csv',
        'ALSS-YOLO-m': r'plot_material/comparsion_experiment/ASS-YOLO-m_F1_curve.csv',
        'ALSS-YOLO': r'plot_material/comparsion_experiment/ass-focus-poolconv-0.886_F1_curve.csv',
    }
    original_colors = [
        (254, 194, 17),
        (81,  81, 81),
    ...
    plt.grid()  # 显示网格线
    # 显示图像
    fig.savefig("plot_curve/comparsion_F1.png", dpi=520)
    # plt.show()
...
def plot_MAP():
    ...
    plt.grid()  # 显示网格线
    plt.legend()
    fig.savefig("plot_curve/comparsion_mAP0.5.png", dpi=520)
