...
if __name__ == '__main__':
    ...
    parser.add_argument('remote_repo_url', nargs='?', default="https://github.com/helloworlder8/CLIP.git", help="The URL of the remote Git repository. Default is 'https://github.com/helloworlder8/computer_vision.git'")
